...
并不是的，比如如下两条intrinsics API 并不对应真实的RVV指令，还有其它API，见[pseudo-intrinsics](https://github.com/riscv-non-isa/rvv-intrinsic-doc/blob/main/doc/rvv-intrinsic-spec.adoc#pseudo-intrinsics)：
